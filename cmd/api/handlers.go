...
func (app *application) Login(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil || !validPassword {
		app.errorJson(w, errors.New("02 invalid username/password"))
		return
	}
...
func (app *application) Logout(w http.ResponseWriter, r *http.Request) {
	...
	err = app.models.User.Token.DeleteByToken(requestPayload.Token)
	if err != nil {
		app.errorJson(w, errors.New("error deleting token"))
		return
	}
...
func (app *application) LogUserOutAdnSetInactive(w http.ResponseWriter, r *http.Request) {
	userId, err := strconv.Atoi(chi.URLParam(r, "id"))
	if err != nil {
		app.errorJson(w, err)
		return
	...
	err = app.models.Token.DeleteTokensFroUser(userId)
	if err != nil {
		app.errorJson(w, err)
		return
	}
